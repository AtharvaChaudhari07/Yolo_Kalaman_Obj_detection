...
from Bounding_Box_Center import get_bounding_box_center_frame
import cv2
import os
...
video_path = os.path.join(parent_directory, 'Data', 'walk_11.mp4')
output_video_path = os.path.join(parent_directory, 'Output', 'walk_11_output.mp4')
print(video_path)
